...
defmodule Astarte.Core.Triggers.SimpleTriggerConfig do
  ...
  defp get_data_trigger_object_for_device(device_id, "*", _interface_major) do
  ...
  defp get_data_trigger_object_for_device(device_id, interface_name, interface_major)
  ...
  defp get_data_trigger_object_for_group(group_name, "*", _interface_major) do
  ...
  defp get_data_trigger_object_for_group(group_name, interface_name, interface_major)
       when is_binary(interface_name) and is_integer(interface_major) do
    interface_id = CQLUtils.interface_id(interface_name, interface_major)
