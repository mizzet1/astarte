...
defmodule Astarte.FDO.OwnerKeyOptions do
  @moduledoc """
  Schema and validation for owner key upload/creation options.
  ...
  @doc false
  def changeset(%OwnerKeyOptions{} = owner_key_request, attrs) do
    cast_attrs = [
      :action,
      :key_name,
      :key_data,
